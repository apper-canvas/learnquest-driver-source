...
// Helper functions for skills mastered
  const getSkillsMastered = (progress) => {
    ...
    return typeof progress.skills_mastered_c === 'string' 
      ...
      ? progress.skills_mastered_c 
      : [];
  };

  const getSkillsMasteredCount = (progress) => {
    return getSkillsMastered(progress).length;
  };
...
{progress.total_stars_c || 0} Stars
                ...
                <Badge variant="success">
                  ...
                  {getSkillsMasteredCount(progress)} Skills Mastered
                </Badge>
                <Badge variant="info">
